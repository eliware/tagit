...
The specification documents are the complete set of Markdown files in this
directory: `overview.md`, `commands.md`, `release-workflow.md`,
`validation.md`, `gitops.md`, and `out-of-scope.md`.
