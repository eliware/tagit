...
test('finds missing package metadata', () => {
  expect(missingPackageMetadata({ name: 'demo', license: 'MIT' })).toEqual(expect.arrayContaining(['version', 'description', 'keywords', 'author', 'repository', 'homepage', 'scripts.test', 'scripts.lint', 'files', 'publishConfig.access=public']));
