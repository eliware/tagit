...
} from '../../../src/repository/metadata/validate-package-metadata.mjs';

test('finds missing package metadata', () => {
  expect(missingPackageMetadata({ name: 'demo', license: 'MIT' })).toEqual(
...
test('accepts complete public package metadata', () => {
  expect(
    missingPackageMetadata({
      ...
      keywords: ['demo'],
      author: 'Eli',
      repository: { url: 'https://github.com/eliware/demo.git' },
      homepage: 'https://github.com/eliware/demo',
      bugs: { url: 'https://github.com/eliware/demo/issues' },
      license: 'MIT',
      engines: { node: '>=26' },
